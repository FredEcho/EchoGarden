    ...
    <div className={`flex items-center space-x-3 ${className}`}>
      ...
      <div className={`${sizeClasses[size]} rounded-full bg-gradient-to-br from-purple-600 via-pink-500 to-orange-500 flex items-center justify-center shadow-lg`}>
        ...
        >
          ...
          <path d="M12 20v-8" />
          {/* Left leaf */}
          <path d="M8 12c0-1 1-2 2-2s2 1 2 2" fill="none" />
          <path d="M7 13c1-1 2-1 3 0" fill="none" />
          {/* Right leaf */}
          <path d="M16 12c0-1-1-2-2-2s-2 1-2 2" fill="none" />
          <path d="M17 13c-1-1-2-1-3 0" fill="none" />
        </svg>
      </div>
